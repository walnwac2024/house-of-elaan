...
const AboutUs = () => {
  return (
    <>
      <div className="relative w-full min-h-52 sm:h-80 md:h-96 lg:min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
          <div className="mt-[-10%] xs:ml-[25%] xs:mt-[-2%] sm:mt-0 ml-[23%] sm:ml-[25%] md:ml-[25%] lg:ml-[25%] w-[50%] xs:w-[43%] sm:w-[50%] md:w-[60%] lg:w-[50%] xl:w-[43%] bg-white/80 backdrop-blur-sm rounded-lg pt-1 xs:pt-0 sm:p-6 lg:p-8 xl:p-8">
            {/* About Us Title */}
            ...
            <p className="text-[6px] sm:text-[10px] md:text-[15px] font-normal text-black leading-tight text-justify">

                    ...
                    <div className="flex flex-wrap bg-opacity-70 p-10 rounded-lg">
                        <div className="w-full md:w-1/3 flex items-center mb-10 md:mb-5">
                            <div>
                                ...
                                />
                                <p className={`text-[10px] md:text-[15px] leading-normal w-full text-justify mr-4 ${activeImage === "HOE/Elaan-marketing-BG-2.jpg" ? 'text-white' : 'text-black bg-white/50 backdrop-blur-xs p-2'}`}>

...
const Elaanpage = () => {
    const [activeImage, setActiveImage] = useState("logos/Elaan-marketing-BG-2.JPG");
    ...
    const images = [
        "logos/GRC-1920x1080.jpg", 
        "logos/Islamabad-Square-1920x1080.jpg", 
        "logos/TCT-Elevation-1080x1920.jpg", 
        "logos/The-Magnus-Mall-1920x1080.jpg"
    ];
        ...
        <div className="relative w-full overflow-hidden">
            ...
            <div id="Elan-company" className="relative flex items-center justify-center">
                <div className="container mx-auto px-4 py-6 max-w-screen-xl">
                    <div className="flex flex-wrap bg-opacity-70 p-10 rounded-lg">
                        <div className="w-full md:w-1/3 flex items-center mb-10 md:mb-5">
                            <div>
                                <img 
                                ...
                                />
                                <p className={`text-base leading-relaxed w-full text-justify mr-4 ${activeImage === "logos/Elaan-marketing-BG-2.JPG" ? 'text-white' : 'text-black'}`}>
                        ...
                        <div className="w-full md:w-2/3 flex flex-wrap items-end justify-end relative">
                                ...
                                {images.map((image, index) => (
                                    image !== activeImage && (
                                        <img 
                                            ...
                                            className={`w-1/3 sm:w-1/4 md:w-1/5 h-32 sm:h-40 md:h-48 object-cover p-1 cursor-pointer transition-transform duration-300 hover:scale-105 

...
GROUP OF COMPANIES</span> 
            ...
            <p className="text-sm sm:text-sm md:text-base lg:text-lg text-gray-800 leading-relaxed text-justify">
            IT IS A REVOLUTION IN MODERN BUSINESS SOLUTIONS.
            WE INVITE YOU TO BE PART OF OUR JOURNEY TOWARDS
            </p>
            <h2 className=" xxs:text-base sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-left mb-4 sm:mb-6">

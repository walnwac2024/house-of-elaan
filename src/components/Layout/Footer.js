  ...
  <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      ...
      <div className="md:w-[316px]">
        ...
        <div className="mt-[23px] flex me-[15px]" style={{ marginLeft: "10px" }}
        >
          <div className="flex h-[38px] w-[35px] items-center justify-center rounded-[75%]">
          ...
          <div className="ml-[18px]">
            ...
            <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">Office 1, 1st Floor, Gulberg Trade Center, Gulberg Greens Block B, Islamabad Capital Territory, Pakistan</a>
          </div>
        </div>
      </div>
